...
QT_MOC_LITERAL(3, 30, 8), // "GameOver"
QT_MOC_LITERAL(4, 39, 20) // "GameConditionChanged"

    },
    "QGameAdventureMode\0GameStart\0\0GameOver\0"
    "GameConditionChanged"
};
#undef QT_MOC_LITERAL
...
void QGameAdventureMode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->GameConditionChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_MOC_LITERAL(3, 29, 10), // "getMessage"
QT_MOC_LITERAL(4, 40, 11), // "sendMessage"
QT_MOC_LITERAL(5, 52, 11) // "objectNames"

    },
    "QGameNetFightMode\0GameStart\0\0getMessage\0"
    "sendMessage\0objectNames"
};
#undef QT_MOC_LITERAL
...
void QGameNetFightMode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendMessage((*reinterpret_cast< objectNames(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        default: ;
        }
    }
}
